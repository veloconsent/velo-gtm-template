...

{
  ...
  "description": "Reads Velo\u0027s consent decision from the data layer and forwards it to Google Consent Mode v2 using the same category-to-signal mapping as the Velo SDK. See this repo\u0027s README for setup.",
  "containerContexts": [
    "WEB"
  ]
}
